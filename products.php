    ...
    <body>
      ...
      <div class="body-below text-center">
        <div class="card-deck mb-4 mt-4">
          <div class="card">
            <img class="card-img-top" src="pics\firealarm.svg" alt="Card image cap" style="padding: 0% 20% 0% 20%">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="pics\network.svg" alt="Card image cap" style="padding: 0% 20% 0% 20%">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="pics\fax.svg" alt="Card image cap" style="padding: 0% 20% 0% 20%">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="pics\cctv.svg" alt="Card image cap" style="padding: 0 20% 0 20%">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="pics\mic.svg" alt="Card image cap" style="padding: 0 20% 0 20%">
            <div class="card-body">
        ...
        <div class="card-deck mb-4">
          <div class="card">
            <img class="card-img-top" src="pics\ethernet.svg" alt="Card image cap" style="padding: 0 20% 0 20%">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="pics\burglar.svg" alt="Card image cap" style="padding: 0 20% 0 20%">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="pics\doorlock.svg" alt="Card image cap" style="padding: 0 20% 0 20%">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="pics\towers.svg" alt="Card image cap" style="padding: 0 20% 0 20%">
            <div class="card-body"> 
          ...
          <div class="card">
            <img class="card-img-top" src="pics\energy.svg" alt="Card image cap" style="padding: 0 20% 0 20%">
            <div class="card-body">
        ...
        <div class="card-deck mb-4">
          <div class="card">
            <img class="card-img-top" src="pics\roll.svg" alt="Card image cap" style="padding: 0 20% 0 20%">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="pics\cabling.svg" alt="Card image cap" style="padding: 0 20% 0 20%">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="pics\dish.svg" alt="Card image cap" style="padding: 0 20% 0 20%">
            <div class="card-body">
          ...
          <div class="card">
            <img class="card-img-top" src="pics\fibericon.svg" alt="Card image cap" style="padding: 0 20% 0 20%">
            <div class="card-body">
